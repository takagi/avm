...
(defmethod built-in-functions ((engine (eql :lisp)))
  '((+ (a a a)
    ...
    (dot ((:vector a b) (:vector a b) a)
         ((((:vector int 2) (:vector int 2) int) int2-dot*)
          (((:vector int 3) (:vector int 3) int) int3-dot*)
          (((:vector int 4) (:vector int 4) int) int4-dot*)
          (((:vector float 2) (:vector float 2) float) float2-dot*)
          (((:vector float 3) (:vector float 3) float) float3-dot*)
          (((:vector float 4) (:vector float 4) float) float4-dot*)
          (((:vector double 2) (:vector double 2) double) double2-dot*)
          (((:vector double 3) (:vector double 3) double) double3-dot*)
          (((:vector double 4) (:vector double 4) double) double4-dot*)))
